...
import appleIconImageSrc from "images/V9SiteDirImg.jpeg";
...
const ImageColumn = tw(Column)`ml-auto lg:mr-0 relative mt-16 lg:mt-0 lg:ml-32 md:mt-0 `;
...
export default ({
  heading = "Soluções inteligentes para um mundo mais humano...",
  description = "Seja bem a Valor9!\n Somos uma familia de profissionais especializados, e juntos trabalhamos na criação de ferramentas tecnológicas de alto valor.",
  imageSrc = appleIconImageSrc,
  imageDecoratorBlob = true,
  primaryButtonUrl = "/pages/innerPages/ContactUsPage",
  primaryButtonText = "Contato",
  buttonRounded = true,
  features = ["Foco em Resultados","Consultores Experientes", "Projetos Eficientes", ],
  testimonial = {
    quote: "",
  ...
  // const navLinks = [
  //   <NavLinks key={1}>
  //     <NavLink href="#" onClick={() => navigate(`/Sobre`)}>Sobre</NavLink>
  //     {/* <NavLink href="/#">Blog</NavLink> */}
  //     {/* <NavLink href="/#">Pricing</NavLink> */}
  //     <NavLink href="#" onClick={() => navigate(`/Contato`)}>Contato</NavLink>  
  //   </NavLinks>
  // ];
  return (
    <>
