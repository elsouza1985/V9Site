...
export default ({
  subheading = "",
  heading = "Mais de 500 Projetos Desenvolvidos",
  description = "Somos especialistas em projetos de inovação, modernização, inteligencia artificial e plataformas de low code",
  stats = [
    {
