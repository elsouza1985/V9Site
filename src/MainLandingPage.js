...
export default () => {
  return (
    <AnimationRevealPage>
      ...
      <FeatureStats/>
      <Features 
        heading={<>Consultoria <HighlightedText>Inteligente</HighlightedText></>}
        // subheading="Projetos"
        description={<>Consultoria qualificada com vivencia de projetos desafiadores nos mais variados setores, dominamos tecnologias Microsoft.</>}
      />
      {/* <MainFeature
